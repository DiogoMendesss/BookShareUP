...
<main class = "profile-main">
    <section class = "profile-pic">
        <img src = "image/users/<?php echo $user_profile ?>.jpg" alt = "Profile Picture">

        <?php if ($user_profile === $up_number) { ?>
    ...
    <section class = "profile-info">
        <h2 id=profile_upNumber> UP Number: <?php echo $user_profile ?> </h2>
        <h2 id=profile_campus> Attending Campus: <?php $user_campuses = getUserFacultyCampus($user_profile);
        ...
        <h2 id=profile_numOwnedBooks> Number of Owned Books: <?php echo getNumOwnedBooks($user_profile) ?> </h2>
    </section>
